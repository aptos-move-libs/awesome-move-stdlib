...
module awesome_stdlib::min_heap_u64 {
    ...
    public fun new(): MinHeap {
        MinHeap::V1 { inner: vector[] }
    }

    /// Creates an empty heap
    public fun new_max(): MinHeap {
        MinHeap::V1  { inner: vector[] }
    }
    ...
    fun heapify_inner(array: &mut vector<u64>, size: u64, root: u64): Option<u64> {
        ...
        let smallest = root;
        let smallest_value = array[smallest];
