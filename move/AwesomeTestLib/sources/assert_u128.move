#[test_only]
/// A module for asserting u128 values
module awesome_stdlib::assert_u128 {
    use aptos_std::debug;
    use aptos_std::string_utils;

    /// Asserts that the values are equal, returning the error code if failed
    public fun eq(expected: u128, actual: u128, err: u64) {
        if (expected != actual) {
            debug::print(
    ...
    /// Asserts that the values are equal, returning the error code if failed
    public fun ne(expected: u128, actual: u128, err: u64) {
        if (expected == actual) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} != {}", expected, actual
    ...
    public fun lt(left: u128, right: u128, err: u64) {
        if (left >= right) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} < {}", left, right
    ...
    public fun le(left: u128, right: u128, err: u64) {
        if (left > right) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} <= {}", left, right
    ...
    public fun gt(left: u128, right: u128, err: u64) {
        if (left <= right) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} <= {}", left, right
    ...
    public fun ge(left: u128, right: u128, err: u64) {
        if (left < right) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} <= {}", left, right
