#[test_only]
/// A module for asserting u16 values
module awesome_stdlib::assert_u16 {
    use aptos_std::debug;
    use aptos_std::string_utils;

    /// Asserts that the values are equal, returning the error code if failed
    public fun eq(expected: u16, actual: u16, err: u64) {
        if (expected != actual) {
            debug::print(
    ...
    public fun ne(expected: u16, actual: u16, err: u64) {
        if (expected == actual) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} != {}", expected, actual
    ...
    public fun lt(left: u16, right: u16, err: u64) {
        if (left >= right) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} < {}", left, right
    ...
    public fun le(left: u16, right: u16, err: u64) {
        if (left > right) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} <= {}", left, right
    ...
    public fun gt(left: u16, right: u16, err: u64) {
        if (left <= right) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} <= {}", left, right
    ...
    public fun ge(left: u16, right: u16, err: u64) {
        if (left < right) {
            debug::print(
                &string_utils::format2(
                    &b"Assertion failed:\n    Expected: {} <= {}", left, right
